...
<head>
    ...
    <title>Изменение характеристики объекта</title>
    <style>
        body {
...
<h2>Характеристика объекта: ${acq.category.name}</h2>

<%--@elvariable id="acq" type=""--%>
<form:form action="/estimator/updateCategoryQuantity/${aptId}" modelAttribute="acq" class="form-container" >
    ...
    <div class="form-group">
        <label class="form-label">Количество (${acq.category.unit})</label>
