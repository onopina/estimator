...
<head>
    ...
    <title>Инфо о цене работы</title>
    <style>
        body {
    ...
    <c:if test="${not empty categoryError}">
        ...
        <form:select path="category.id" class="styled-input">
            ...
            <c:forEach items="${allCategories}" var="category">
                <form:option value="${category.id}">${category.categoryName.name} (${category.unit})</form:option>
            </c:forEach>
        </form:select>

    <div class="form-group">
        <label class="form-label">Наименование работы</label>
        <form:input path="workTitle" class="styled-input"/>
        <form:errors path="workTitle" class="alert alert-danger" />
    </div>
